...
public class DmxUniverseRepository : IUniverseSource, IUniverseSink
{
    ...
    /// </summary>
    private readonly ConcurrentDictionary<LittleEndianUniverse, long> DetectedUniverses = new();

    /// <summary>
    /// Universes we should keep the DMX data of, will be kept here.
    /// </summary>
    private readonly ConcurrentDictionary<LittleEndianUniverse, SequenceNumberedUniverse> SubscribedUniverses = new();
    ...
    public IUniverse SetUniverseSubscribed(LittleEndianUniverse universeNumber)
    {
        var newUniverse = new SequenceNumberedUniverse();
        SubscribedUniverses[universeNumber] = newUniverse;
        return newUniverse;
    }
